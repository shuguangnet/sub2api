<template>
  <AppLayout>
    <div class="space-y-6">
        ...
        <div class="card p-4">
          <div class="flex flex-wrap items-center gap-4">
            <div class="flex items-center gap-2">
              <span class="text-sm font-medium text-ink">{{ t('admin.dashboard.timeRange') }}:</span>
              <DateRangePicker
            ...
            <div class="ml-auto flex items-center gap-2">
              <span class="text-sm font-medium text-ink">{{ t('admin.dashboard.granularity') }}:</span>
              <div class="w-28">
      ...
      <div v-if="errorViewEnabled" class="flex gap-2 border-b border-line">
