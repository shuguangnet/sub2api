  ...
  <AuthLayout>
    <div class="space-y-6">
      ...
      <div class="auth-head text-center mb-8">
        ...
        <h2 class="auth-title font-display">{{ t('auth.createAccount') }}</h2>
        <p class="auth-sub"><em>{{ t('auth.signUpToStart', { siteName }) }}</em></p>
      </div>
      ...
      <form v-else @submit.prevent="handleRegister" class="space-y-5">
        ...
        <div v-if="invitationCodeEnabled">
          ...
          <div class="relative">
            <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3.5">
              <Icon name="key" size="md" :class="invitationValidation.valid ? 'text-green-500' : 'text-ink-subtle'" />
            </div>
            <input
              id="invitation_code"
        ...
        <div v-if="promoCodeEnabled">
          <label for="promo_code" class="input-label">
            ...
            <span class="ml-1 text-xs font-normal text-ink-subtle">({{ t('common.optional') }})</span>
          </label>
          <div class="relative">
            <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3.5">
              <Icon name="gift" size="md" :class="promoValidation.valid ? 'text-green-500' : 'text-ink-subtle'" />
            </div>
            <input
              id="promo_code"
